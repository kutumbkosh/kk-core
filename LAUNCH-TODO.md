...
- [ ] Test Razorpay payment flow (Pro subscription — annual AND monthly) — BLOCKED: requires Shubham to complete Razorpay KYC + live mode activation first. Engineering spec at docs/FINANCE-RAZORPAY-ENGINEERING-HANDOFF.docx. Monthly billing (₹49/month) confirmed 2026-05-21; Engineering to add monthly Razorpay plan per HANDOFFS.md ID 55.
